...
//        output = new String(output.getBytes("UTF-8"), "ISO-8859-1");
    ...
    public static String generateSignedXml(final Map<String, Object> data, String key) throws Exception {
        return generateSignedXml(data, key, com.github.wxpay.sdk.WXPayConstants.SignType.MD5);
    }
     ...
     * @return 含有sign字段的XML
     */
    public static String generateSignedXml(final Map<String, Object> data, String key, com.github.wxpay.sdk.WXPayConstants.SignType signType) throws Exception {
    ...
    public static String generateSignature(final Map<String, Object> data, String key) throws Exception {
        return generateSignature(data, key, com.github.wxpay.sdk.WXPayConstants.SignType.MD5);
    }
